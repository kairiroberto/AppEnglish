...
public class TabFragment1Adapter extends RecyclerView.Adapter<TabFragment1Adapter.Tab1ViewHolder> {
    ...
    public TabFragment1Adapter(List<Fala> myDataset, Context context) {
        mDataset = myDataset;
        this.context = context;
    }
